...
public class RedisService {
     ...
     * @return Boolean
     */
    public Boolean lSingleSet(String key, Object value, Long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return Boolean
     */
    public Long lRPush(String key, List<Object> values) {
     ...
     * @return Boolean
     */
    public Object clList(String key) {
        try {
    ...
    public Object zIncrement(String key, Long value, double score) {
    ...
    public Set<ZSetOperations.TypedTuple<Object>> zRangeByScore(String key, long min, long max) {
        return redisTemplate.opsForZSet().rangeWithScores(key, min, max);
    }

    public List<Object> hmrget(String key, Collection hashKeys) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<Object>> zSetGetByPage(String key, int pageNum, int pageSize) {
        try {
    ...
    public void zInterScore(String firstKey, String secondKey, String destKey) {
        redisTemplate.opsForZSet().intersectAndStore(firstKey, secondKey, destKey);
    }
}
